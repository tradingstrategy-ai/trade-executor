...
from tradeexecutor.visual.grid_search_visualisation import calculate_rolling_metrics, BenchmarkFunction
...
def test_grid_search_visualisation(
    strategy_universe,
    indicator_storage,
    tmp_path,
):
