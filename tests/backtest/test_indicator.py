...
from tradeexecutor.strategy.pandas_trader.indicator import IndicatorBuilder
...
def test_indicators_single():
    ...
    def create_indicators(parameters: StrategyParameters, indicators: IndicatorBuilder):
