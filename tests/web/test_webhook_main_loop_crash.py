...
@flaky.flaky
@pytest.mark.skipif(os.environ.get("JSON_RPC_BINANCE") is None or os.environ.get("CI") == "true", reason="Set JSON_RPC_BINANCE environment variable to Binance Smart Chain node to run this test")
