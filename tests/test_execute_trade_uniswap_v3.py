...
from tradeexecutor.ethereum.execution_uniswap_v3 import get_current_price
...
def test_execute_trade_instructions_buy_weth_with_tester(
    ...
    # Buy 500 USDC worth of WETH
    trader = EthereumTestTraderUniswapV3(web3, uniswap_v3, hot_wallet, state, pair_universe)
