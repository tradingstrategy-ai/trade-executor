...
def test_serialize_state(usdc, weth_usdc, start_ts: datetime.datetime):
    ...
    assert isinstance(summary.average_duration_of_won_positions, datetime.timedelta)
    assert isinstance(summary.average_duration_of_lost_positions, datetime.timedelta)
