...
- Add manifest-gated HyperCore decision slots, private verified price snapshots, point-in-time deposit availability and skipped-entry diagnostics; support sparse four-hour observations and explicit timeout recovery (2026-09-22).
