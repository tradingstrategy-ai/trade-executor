"""Test strategy for exchange account position on Anvil.

A minimal strategy that creates a single exchange account position
for testing sync and valuation flows on a local Anvil chain.
...
def create_trading_universe(
    ...
    # Use real USDC address from environment if available (for Anvil testing)
