...
from .commands.vault_test_trade import vault_test_trade
...
__all__ = [
    ...
    export, hello, init, lagoon_deploy_vault, lagoon_first_deposit, lagoon_manual_settle, lagoon_reclaim_satellites, lagoon_redeem, lagoon_settle, perform_test_trade, prepare_report, prune_state,
