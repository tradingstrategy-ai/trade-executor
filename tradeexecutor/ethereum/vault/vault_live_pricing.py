...
class VaultPricing(EthereumPricingModel):
    ...
    def __init__(
        ...
        self.vault_cache: Dict[TradingPairIdentifier, ERC4626Vault] = {}
    ...
    def get_vault(self, target_pair: TradingPairIdentifier) -> UniswapV3Deployment:
