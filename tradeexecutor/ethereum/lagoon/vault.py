...
class LagoonVaultSyncModel(AddressSyncModel):
    ...
    def calculate_valuation(self, state: State) -> USDollarPrice:
        ...
        for p in state.portfolio.get_open_and_frozen_positions():
            ...
            assert updated_ago < self.valuation_data_freshness, f"Position pricing was too old for Lagoon valuation update. Now: {now}, updated at: {p.last_pricing_at}, diff: {updated_ago}"
