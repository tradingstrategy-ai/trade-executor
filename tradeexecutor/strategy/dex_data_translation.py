...
def translate_trading_pair(dex_pair: DEXPair, cache: dict | None = None) -> TradingPairIdentifier:
    ...
    assert base_token_decimals is not None, f"Base token missing decimals: {dex_pair}"
    ...
    pair = TradingPairIdentifier(
        ...
        other_data=dex_pair.other_data or {},
    )
    ...
    if dex_pair.other_data:
        ...
        match metadata:
            ...
            case VaultMetadata():
                ...
                pair.other_data["vault_estimated_settlement"] = getattr(metadata, "estimated_settlement", None)
