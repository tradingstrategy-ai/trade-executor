...
class State:
    ...
    #: timestamp.
    #: Expired slots without trades advance automatically on restart; slots
    #: with persisted trades must be reconciled before another decision.
    ...
    def mark_trade_success(
        ...
        native_token_price: USDollarPrice | None,
