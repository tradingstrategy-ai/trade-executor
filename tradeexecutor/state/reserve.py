...
class ReservePosition:
    ...
    #: Balance updates touching this reserve.
    #:
    #: Generated by :py:class:`tradeexecutor.strategy.sync_model.SyncModel`.
    #:
    #: A list of `BalanceUpdate.id` list.
    #: Actual events are stored in :py:class:`tradeexecutor.state.sync.Treasury`
    #:
    balance_updates: List[int] = field(default_factory=list)
